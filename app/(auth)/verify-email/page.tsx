...
export const metadata: Metadata = {
  ...
  description: "Enter the one-time code sent to your email to finish creating your account.",
};
      ...
      <Card className="relative z-10 w-full max-w-md border-border/60 shadow-medium">
        <CardHeader className="space-y-5 text-center">
          ...
          <div className="space-y-1.5">
            ...
            <CardDescription>
              Account created successfully. Enter the 6-digit code to activate your account.
            </CardDescription>
          </div>
        </CardHeader>
        <CardContent>
