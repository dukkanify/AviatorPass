...
export const NOTIFICATION_CATALOG: Record<string, NotificationTypeDefinition> = {
  ...
  "account.password_reset": {
    ...
    defaultBody: "A password reset was requested for your account.",
    audiences: ["all"],
  },
  "account.verification": {
    ...
    defaultBody: "Confirm your email address to finish registration.",
    audiences: ["all"],
  },
  ...
  "course.published": {
    ...
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Course published",
    defaultBody: "A course is now available.",
  ...
  "course.enrolled": {
    ...
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Enrolment confirmed",
  ...
  "student.live_welcome": {
    type: "student.live_welcome",
    category: "course",
    priority: "high",
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Your live program starts today",
    defaultBody: "Your live AviatorPass program is ready — open My Courses and the timetable.",
    audiences: ["student"],
  },
  ...
  "payment.purchase": {
    ...
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Course purchase",
    defaultBody: "Your course purchase is confirmed.",
    audiences: ["student", "admin", "super_admin"],
  },
  "payment.refunded": {
    ...
    defaultBody: "A refund was issued on your order.",
    audiences: ["student", "admin", "super_admin"],
  },
  "refund.approved": {
    ...
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Refund approved",
    defaultBody: "Your refund was approved and processed.",
    audiences: ["student", "admin", "super_admin"],
  },
  "refund.rejected": {
    ...
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Refund rejected",
    defaultBody: "Your refund request was rejected.",
    audiences: ["student", "admin", "super_admin"],
  },
  "payment.failed": {
    type: "payment.failed",
  ...
  "zoom.meeting.created": {
    ...
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Zoom meeting created",
    defaultBody: "A Zoom meeting is ready for your live class.",
    audiences: ["student", "instructor"],
  },
  "zoom.meeting.updated": {
    ...
    delivery: "grouped",
    emailDefault: true,
    defaultTitle: "Zoom meeting updated",
    defaultBody: "A Zoom meeting was updated.",
    audiences: ["student", "instructor"],
  },
  "zoom.meeting.cancelled": {
    ...
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Zoom meeting cancelled",
    defaultBody: "A Zoom meeting was cancelled.",
    audiences: ["student", "instructor", "cgi"],
  },
  "zoom.meeting.starts_soon": {
    ...
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Zoom meeting starts soon",
    defaultBody: "Your Zoom live class is starting soon.",
    audiences: ["student", "instructor"],
  },
  "zoom.meeting.finished": {
    ...
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Zoom meeting finished",
    defaultBody: "Your Zoom live class has ended.",
    audiences: ["student", "instructor"],
  },
  "zoom.oauth.connected": {
    ...
    delivery: "immediate",
    emailDefault: false,
    defaultTitle: "Zoom connected",
    defaultBody: "Your Zoom account is connected.",
    audiences: ["instructor", "cgi"],
  },
  "zoom.oauth.disconnected": {
    type: "zoom.oauth.disconnected",
    category: "system",
    priority: "medium",
    delivery: "immediate",
    emailDefault: false,
    defaultTitle: "Zoom disconnected",
    defaultBody: "Your Zoom account was disconnected.",
    audiences: ["instructor", "cgi"],
  },
  ...
  // Instructor / CGI
  "instructor.new_purchase": {
    type: "instructor.new_purchase",
    category: "payment",
    priority: "medium",
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "New purchase",
    defaultBody: "A student purchased a course you teach.",
    audiences: ["instructor"],
  },
  "instructor.course_assigned": {
    type: "instructor.course_assigned",
    category: "course",
    priority: "high",
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Course assigned",
    defaultBody: "A course was assigned to you.",
    audiences: ["instructor"],
  },
  "instructor.class_reminder": {
    type: "instructor.class_reminder",
    category: "reminder",
    priority: "high",
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Class reminder",
    defaultBody: "You have an upcoming live class.",
    audiences: ["instructor"],
  },
  ...
  "admin.purchase": {
    ...
    emailDefault: true,
    defaultTitle: "New purchase",
    defaultBody: "A student completed a purchase.",
    audiences: ["admin", "super_admin"],
  },
  "admin.payment_received": {
    type: "admin.payment_received",
    category: "ops",
    priority: "high",
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "Payment received",
    defaultBody: "A payment succeeded.",
    audiences: ["admin", "super_admin"],
  },
  ...
  "admin.refund": {
    ...
    emailDefault: true,
    defaultTitle: "Refund",
    defaultBody: "A refund was issued.",
    audiences: ["admin", "super_admin"],
  },
  "admin.new_instructor": {
    type: "admin.new_instructor",
    category: "ops",
    priority: "medium",
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "New instructor",
    defaultBody: "A new instructor joined the platform.",
    audiences: ["admin", "super_admin"],
  },
  "admin.new_course": {
    type: "admin.new_course",
    category: "ops",
    priority: "medium",
    delivery: "immediate",
    emailDefault: true,
    defaultTitle: "New course",
    defaultBody: "A new course was created.",
    audiences: ["admin", "super_admin"],
  },
  "admin.system_alert": {
