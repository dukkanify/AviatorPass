...
export function ensureCoursesSeeded(): void {
  ...
  const categories: CourseCategory[] = [
    {
      ...
      visible: true,
      imageUrl: null,
      seoTitle: "ATPL Theory",
      metaDescription: "Airline Transport Pilot Licence theoretical knowledge courses.",
      metadata: {},
      createdAt: ts,
      updatedAt: ts,
    },
    {
      ...
      visible: true,
      imageUrl: null,
      seoTitle: "Flight Operations",
      metaDescription: "Operational procedures and performance training.",
      metadata: {},
      createdAt: ts,
      updatedAt: ts,
    },
    {
      ...
      imageUrl: null,
      seoTitle: "Air Law",
      metaDescription: "Regulatory frameworks for professional pilots.",
      metadata: {},
      createdAt: ts,
      updatedAt: ts,
    },
  ...
  const sub: CourseCategory = {
    ...
    visible: true,
    imageUrl: null,
    seoTitle: "010 Air Law",
    metaDescription: "EASA ATPL 010 subject.",
