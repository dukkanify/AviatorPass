...
| POST             | `/api/courses/bulk`                            | Bulk publish/archive/delete/assign/category/export/import/price |
...
- `/super-admin/courses`, `/super-admin/courses/new`, `/super-admin/courses/[id]/edit`, `/super-admin/courses/[id]`, `/super-admin/courses/categories`
- `/admin/courses`, `/admin/courses/new`, `/admin/courses/[id]/edit`, `/admin/courses/[id]`, `/admin/courses/categories`
