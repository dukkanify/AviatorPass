...
| ATPL Complete Package               | Aligned (platform) | SKU `ATPL-PACKAGE` · CGI · assignment · reports · schedule · instructor **Unable to Schedule** emails TKI 1 + Super Admin and sets Scheduling Required                                                       |
