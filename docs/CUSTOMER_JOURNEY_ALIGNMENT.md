...
| ATPL Complete Package               | Aligned (platform) | SKU `ATPL-PACKAGE` · CGI · assignment · reports · schedule · instructor **Unable to Schedule** emails TKI 1 + Super Admin · official assignment email `{TK n} has been assigned to you.` (instructor, subject, date, comments, time, meeting link) to student + instructor + TKI 1 + Super User |
